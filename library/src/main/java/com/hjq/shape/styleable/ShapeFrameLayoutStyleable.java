...
public final class ShapeFrameLayoutStyleable implements IShapeDrawableStyleable {
    ...
    public int getSolidPressedStartColorStyleable() {
        return R.styleable.ShapeFrameLayout_shape_pressedStartColor;
    }

    @Override
    public int getSolidPressedCenterColorStyleable() {
        return R.styleable.ShapeFrameLayout_shape_pressedCenterColor;
    }

    @Override
    public int getSolidPressedEndColorStyleable() {
        return R.styleable.ShapeFrameLayout_shape_pressedEndColor;
    }
    ...
    public int getStrokePressedStartColorStyleable() {
        return R.styleable.ShapeFrameLayout_shape_strokePressedStartColor;
    }

    @Override
    public int getStrokePressedCenterColorStyleable() {
        return R.styleable.ShapeFrameLayout_shape_strokePressedCenterColor;
    }

    @Override
    public int getStrokePressedEndColorStyleable() {
        return R.styleable.ShapeFrameLayout_shape_strokePressedEndColor;
    }
