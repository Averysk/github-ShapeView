...
public final class ShapeRadioGroupStyleable implements IShapeDrawableStyleable {
    ...
    public int getSolidPressedStartColorStyleable() {
        return R.styleable.ShapeRadioGroup_shape_pressedStartColor;
    }

    @Override
    public int getSolidPressedCenterColorStyleable() {
        return R.styleable.ShapeRadioGroup_shape_pressedCenterColor;
    }

    @Override
    public int getSolidPressedEndColorStyleable() {
        return R.styleable.ShapeRadioGroup_shape_pressedEndColor;
    }
    ...
    public int getStrokePressedStartColorStyleable() {
        return R.styleable.ShapeRadioGroup_shape_strokePressedStartColor;
    }

    @Override
    public int getStrokePressedCenterColorStyleable() {
        return R.styleable.ShapeRadioGroup_shape_strokePressedCenterColor;
    }

    @Override
    public int getStrokePressedEndColorStyleable() {
        return R.styleable.ShapeRadioGroup_shape_strokePressedEndColor;
    }
