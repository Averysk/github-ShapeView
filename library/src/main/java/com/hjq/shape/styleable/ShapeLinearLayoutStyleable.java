...
public final class ShapeLinearLayoutStyleable implements IShapeDrawableStyleable {
    ...
    public int getSolidPressedStartColorStyleable() {
        return R.styleable.ShapeLinearLayout_shape_pressedStartColor;
    }

    @Override
    public int getSolidPressedCenterColorStyleable() {
        return R.styleable.ShapeLinearLayout_shape_pressedCenterColor;
    }

    @Override
    public int getSolidPressedEndColorStyleable() {
        return R.styleable.ShapeLinearLayout_shape_pressedEndColor;
    }
    ...
    public int getStrokePressedStartColorStyleable() {
        return R.styleable.ShapeLinearLayout_shape_strokePressedStartColor;
    }

    @Override
    public int getStrokePressedCenterColorStyleable() {
        return R.styleable.ShapeLinearLayout_shape_strokePressedCenterColor;
    }

    @Override
    public int getStrokePressedEndColorStyleable() {
        return R.styleable.ShapeLinearLayout_shape_strokePressedEndColor;
    }
