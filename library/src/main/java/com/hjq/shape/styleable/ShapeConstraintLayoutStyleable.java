...
public final class ShapeConstraintLayoutStyleable implements IShapeDrawableStyleable {
    ...
    @Override
    public int getSolidPressedStartColorStyleable() {
        return R.styleable.ShapeConstraintLayout_shape_pressedStartColor;
    }

    @Override
    public int getSolidPressedCenterColorStyleable() {
        return R.styleable.ShapeConstraintLayout_shape_pressedCenterColor;
    }

    @Override
    public int getSolidPressedEndColorStyleable() {
        return R.styleable.ShapeConstraintLayout_shape_pressedEndColor;
    }
    ...
    @Override
    public int getStrokePressedStartColorStyleable() {
        return R.styleable.ShapeConstraintLayout_shape_strokePressedStartColor;
    }

    @Override
    public int getStrokePressedCenterColorStyleable() {
        return R.styleable.ShapeConstraintLayout_shape_strokePressedCenterColor;
    }

    @Override
    public int getStrokePressedEndColorStyleable() {
        return R.styleable.ShapeConstraintLayout_shape_strokePressedEndColor;
    }
