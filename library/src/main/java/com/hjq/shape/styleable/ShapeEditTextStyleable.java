...
public final class ShapeEditTextStyleable implements IShapeDrawableStyleable, ITextColorStyleable {
    ...
    public int getSolidPressedStartColorStyleable() {
        return R.styleable.ShapeEditText_shape_pressedStartColor;
    }

    @Override
    public int getSolidPressedCenterColorStyleable() {
        return R.styleable.ShapeEditText_shape_pressedCenterColor;
    }

    @Override
    public int getSolidPressedEndColorStyleable() {
        return R.styleable.ShapeEditText_shape_pressedEndColor;
    }
    ...
    public int getStrokePressedStartColorStyleable() {
        return R.styleable.ShapeEditText_shape_strokePressedStartColor;
    }

    @Override
    public int getStrokePressedCenterColorStyleable() {
        return R.styleable.ShapeEditText_shape_strokePressedCenterColor;
    }

    @Override
    public int getStrokePressedEndColorStyleable() {
        return R.styleable.ShapeEditText_shape_strokePressedEndColor;
    }
