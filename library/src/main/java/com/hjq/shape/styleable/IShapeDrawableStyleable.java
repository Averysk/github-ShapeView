...
public interface IShapeDrawableStyleable {
    ...
    int getSolidPressedStartColorStyleable();

    int getSolidPressedCenterColorStyleable();

    int getSolidPressedEndColorStyleable();
    ...
    int getStrokePressedStartColorStyleable();

    int getStrokePressedCenterColorStyleable();

    int getStrokePressedEndColorStyleable();
