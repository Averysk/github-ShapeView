...
public final class ShapeRecyclerViewStyleable implements IShapeDrawableStyleable {
    ...
    public int getSolidPressedStartColorStyleable() {
        return R.styleable.ShapeRecyclerView_shape_pressedStartColor;
    }

    @Override
    public int getSolidPressedCenterColorStyleable() {
        return R.styleable.ShapeRecyclerView_shape_pressedCenterColor;
    }

    @Override
    public int getSolidPressedEndColorStyleable() {
        return R.styleable.ShapeRecyclerView_shape_pressedEndColor;
    }
    ...
    public int getStrokePressedStartColorStyleable() {
        return R.styleable.ShapeRecyclerView_shape_strokePressedStartColor;
    }

    @Override
    public int getStrokePressedCenterColorStyleable() {
        return R.styleable.ShapeRecyclerView_shape_strokePressedCenterColor;
    }

    @Override
    public int getStrokePressedEndColorStyleable() {
        return R.styleable.ShapeRecyclerView_shape_strokePressedEndColor;
    }
