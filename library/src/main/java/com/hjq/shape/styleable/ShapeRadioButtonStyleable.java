...
public final class ShapeRadioButtonStyleable implements IShapeDrawableStyleable,
    ...
    public int getSolidPressedStartColorStyleable() {
        return R.styleable.ShapeRadioButton_shape_pressedStartColor;
    }

    @Override
    public int getSolidPressedCenterColorStyleable() {
        return R.styleable.ShapeRadioButton_shape_pressedCenterColor;
    }

    @Override
    public int getSolidPressedEndColorStyleable() {
        return R.styleable.ShapeRadioButton_shape_pressedEndColor;
    }
    ...
    public int getStrokePressedStartColorStyleable() {
        return R.styleable.ShapeRadioButton_shape_strokePressedStartColor;
    }

    @Override
    public int getStrokePressedCenterColorStyleable() {
        return R.styleable.ShapeRadioButton_shape_strokePressedCenterColor;
    }

    @Override
    public int getStrokePressedEndColorStyleable() {
        return R.styleable.ShapeRadioButton_shape_strokePressedEndColor;
    }
