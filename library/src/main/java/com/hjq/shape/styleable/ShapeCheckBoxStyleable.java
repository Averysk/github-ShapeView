...
public final class ShapeCheckBoxStyleable implements IShapeDrawableStyleable,
    ...
    public int getSolidPressedStartColorStyleable() {
        return R.styleable.ShapeCheckBox_shape_pressedStartColor;
    }

    @Override
    public int getSolidPressedCenterColorStyleable() {
        return R.styleable.ShapeCheckBox_shape_pressedCenterColor;
    }

    @Override
    public int getSolidPressedEndColorStyleable() {
        return R.styleable.ShapeCheckBox_shape_pressedEndColor;
    }
    ...
    public int getStrokePressedStartColorStyleable() {
        return R.styleable.ShapeCheckBox_shape_strokePressedStartColor;
    }

    @Override
    public int getStrokePressedCenterColorStyleable() {
        return R.styleable.ShapeCheckBox_shape_strokePressedCenterColor;
    }

    @Override
    public int getStrokePressedEndColorStyleable() {
        return R.styleable.ShapeCheckBox_shape_strokePressedEndColor;
    }
