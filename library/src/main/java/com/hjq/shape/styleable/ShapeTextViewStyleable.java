...
public final class ShapeTextViewStyleable implements IShapeDrawableStyleable, ITextColorStyleable {
    ...
    public int getSolidPressedStartColorStyleable() {
        return R.styleable.ShapeTextView_shape_pressedStartColor;
    }

    @Override
    public int getSolidPressedCenterColorStyleable() {
        return R.styleable.ShapeTextView_shape_pressedCenterColor;
    }

    @Override
    public int getSolidPressedEndColorStyleable() {
        return R.styleable.ShapeTextView_shape_pressedEndColor;
    }
    ...
    public int getStrokePressedStartColorStyleable() {
        return R.styleable.ShapeTextView_shape_strokePressedStartColor;
    }

    @Override
    public int getStrokePressedCenterColorStyleable() {
        return R.styleable.ShapeTextView_shape_strokePressedCenterColor;
    }

    @Override
    public int getStrokePressedEndColorStyleable() {
        return R.styleable.ShapeTextView_shape_strokePressedEndColor;
    }
