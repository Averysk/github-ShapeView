...
public final class ShapeDrawableBuilder {
    ...
    private int[] mSolidPressedGradientColors;
    private int[] mStrokePressedGradientColors;
    ...
    public ShapeDrawableBuilder(View view, TypedArray typedArray, IShapeDrawableStyleable styleable) {
        ...
        if (typedArray.hasValue(styleable.getSolidPressedStartColorStyleable()) && typedArray.hasValue(styleable.getSolidPressedEndColorStyleable())) {
            if (typedArray.hasValue(styleable.getSolidPressedCenterColorStyleable())) {
                mSolidPressedGradientColors = new int[] {typedArray.getColor(styleable.getSolidPressedStartColorStyleable(), NO_COLOR),
                        typedArray.getColor(styleable.getSolidPressedCenterColorStyleable(), NO_COLOR),
                        typedArray.getColor(styleable.getSolidPressedEndColorStyleable(), NO_COLOR)};
            } else {
                mSolidPressedGradientColors = new int[] {typedArray.getColor(styleable.getSolidPressedStartColorStyleable(), NO_COLOR),
                        typedArray.getColor(styleable.getSolidPressedEndColorStyleable(), NO_COLOR)};
            }
        ...
        if (typedArray.hasValue(styleable.getStrokePressedStartColorStyleable()) && typedArray.hasValue(styleable.getStrokePressedEndColorStyleable())) {
            if (typedArray.hasValue(styleable.getStrokePressedCenterColorStyleable())) {
                mStrokePressedGradientColors = new int[] {typedArray.getColor(styleable.getStrokePressedStartColorStyleable(), NO_COLOR),
                        typedArray.getColor(styleable.getStrokePressedCenterColorStyleable(), NO_COLOR),
                        typedArray.getColor(styleable.getStrokePressedEndColorStyleable(), NO_COLOR)};
            } else {
                mStrokePressedGradientColors = new int[] {typedArray.getColor(styleable.getStrokePressedStartColorStyleable(), NO_COLOR),
                        typedArray.getColor(styleable.getStrokePressedEndColorStyleable(), NO_COLOR)};
            }
    ...
    public ShapeDrawableBuilder setSolidPressedGradientColors(int startColor, int endColor) {
        return setSolidPressedGradientColors(new int[]{startColor, endColor});
    }

    public ShapeDrawableBuilder setSolidPressedGradientColors(int startColor, int centerColor, int endColor) {
        return setSolidPressedGradientColors(new int[]{startColor, centerColor, endColor});
    }

    public ShapeDrawableBuilder setSolidPressedGradientColors(int[] colors) {
        mSolidPressedGradientColors = colors;
        return this;
    }

    @Nullable
    public int[] getSolidPressedGradientColors() {
        return mSolidPressedGradientColors;
    }

    public boolean isSolidGPressedradientColors() {
        return mSolidPressedGradientColors != null &&
                mSolidPressedGradientColors.length > 0;
    }

    public void clearSolidPressedGradientColors() {
        mSolidPressedGradientColors = null;
    }

    public ShapeDrawableBuilder setStrokePressedGradientColors(int startColor, int endColor) {
        return setStrokePressedGradientColors(new int[]{startColor, endColor});
    }

    public ShapeDrawableBuilder setStrokePressedGradientColors(int startColor, int centerColor, int endColor) {
        return setStrokePressedGradientColors(new int[]{startColor, centerColor, endColor});
    }

    public ShapeDrawableBuilder setStrokePressedGradientColors(int[] colors) {
        mStrokePressedGradientColors = colors;
        return this;
    }

    @Nullable
    public int[] getStrokePressedGradientColors() {
        return mStrokePressedGradientColors;
    }

    public boolean isStrokePressedGradientColors() {
        return mStrokePressedGradientColors != null &&
                mStrokePressedGradientColors.length > 0;
    }

    public void clearStrokePressedGradientColors() {
        mStrokePressedGradientColors = null;
    }
    ...
    public Drawable buildBackgroundDrawable() {
        ...
        if (mSolidPressedGradientColors != null || mStrokePressedGradientColors != null) {
            ShapeDrawable drawable = convertShapeDrawable(stateListDrawable.getPressedDrawable());
            refreshShapeDrawableList(drawable, mSolidPressedGradientColors, mSolidPressedGradientColors);
            stateListDrawable.setPressedDrawable(drawable);
        }
    ...
    public void refreshShapeDrawableList(ShapeDrawable drawable,
                                     @Nullable int[] solidStateColor,
                                     @Nullable int[] strokeStateColor) {
        drawable.setShape(mShape)
                .setSize(mShapeWidth, mShapeHeight)
                .setRadius(mTopLeftRadius, mTopRightRadius, mBottomLeftRadius, mBottomRightRadius)
                .setUseLevel(mUseLevel)
